...
contract UCBNFT is ERC721, Ownable{
    ...
    constructor() payable ERC721('UCB','UCBT'){
    ...
    function mint(uint quantity_) public payable{
        ...
        require(walletMints[msg.sender] + quantity_ <= maxPerWallet, 'Exceed Max Amount per Wallet.');
